...
class Attribute_group {
	...
	public function addAttributeGroup($data) {
		...
		foreach ($data['attribute_group_description'] as $language_id => $value) {
			$this->db->query("INSERT INTO " . DB_PREFIX . "attribute_group_description SET attribute_group_id = '" . (int)$attribute_group_id . "', language_id = '" . (int)$language_id . "', name = " . $this->db->quote($value['name']));
		}
	}
