...
class Product {
	...
	public function getProducts($data = array()) {
		...
		$product_data = $this->cache->get('product.' . (int)$this->config->get('config_language_id') . '.' . (int)$customer_group_id . '.' . $cache);
		...
		if (!$product_data) {
			...
			$this->cache->set('product.' . (int)$this->config->get('config_language_id') . '.' . (int)$customer_group_id . '.' . $cache, $product_data);
		}
	...
	public function getTotalProducts($data = array()) {
		...
		$product_data = $this->cache->get('product.total.' . (int)$this->config->get('config_language_id') . '.' . (int)$customer_group_id . '.' . $cache);
		...
		if (!$product_data) {
			...
			$this->cache->set('product.total.' . (int)$this->config->get('config_language_id') . '.' . (int)$customer_group_id . '.' . $cache, $product_data);
		}
